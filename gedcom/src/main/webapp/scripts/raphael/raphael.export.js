...
//			svg     = '<svg style="overflow: hidden; position: relative;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="' + paper.width + '" version="1.1" height="' + paper.height + '">'
			svg     = '<svg style="overflow: visible; position: relative;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" ' +
				'width="' + (0*paper.width+G.wMin+G.wMax) + '" version="1.1" height="' + (0*paper.height+G.hMin+G.hMax) + '" >'
			;
